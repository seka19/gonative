...
func main() {
	...
	app.Commands = []cli.Command{
		cli.Command{
			...
			Flags: []cli.Flag{
				cli.StringFlag{"version", "1.5.2", "version of Go to build", "", false, "", nil},
				cli.StringFlag{"src", "", "path to go source, empty string means to fetch from internet", "", false, "", nil},
				cli.StringFlag{"target", "go", "target directory in which to build Go", "", false, "", nil},
				cli.StringFlag{"platforms", "", "space separated list of platforms to build, default is 'darwin_amd64 freebsd_amd64 linux_386 linux_amd64 windows_386 windows_amd64'", "", false, "", nil},
			},
			Action: buildCmd,
		},
	}
